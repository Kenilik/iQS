...
$config['tables']['users_groups']    = 'userrole';
$config['tables']['login_attempts']  = 'loginattempt';
 ...
 */
$config['join']['users']  = 'QID';
$config['join']['groups'] = 'RoleID';
 ...
 */
$config['site_title']           	= "kenilik.com"; 		// Site Title, example.com
$config['admin_email']          	= "admin@kenilik.com"; 	// Admin Email, admin@example.com
$config['default_group']        	= 'users'; 				// Default group, use name
$config['admin_group']          	= 'admin'; 				// Default administrators group, use name
$config['identity']             	= 'qid'; 				// A database column which is used to login with
$config['min_password_length']  	= 2; 					// Minimum Required Length of Password
