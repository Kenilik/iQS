...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.countdown.css" type="text/css" media="screen" />	
	...
	<script src="<?php echo base_url();?>js/cookieutils.js" type="text/javascript" charset="utf-8"></script>
	<script src="<?php echo base_url();?>js/jquery.countdown.js" type="text/javascript" charset="utf-8"></script>
	<script src="<?php echo base_url();?>js/dateutils.js" type="text/javascript" charset="utf-8"></script>
